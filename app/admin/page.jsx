...
const NEWSLETTER_TEMPLATES=[
  {name:"開課通知（早鳥分層）",subject:"9/30 正式開課・9/2 搶先開放第一章",body:[
    ...
    "- 學員專屬活動與後續課程的優先邀請",
    "- 了解大家的學習狀況，調整後續內容規劃","",
    "**請使用當初購買時填寫的 Email 登入**：在登入頁點「Email 連結登入（免密碼）」，收到信後點連結或輸入驗證碼即可；第一次登入系統會自動建立帳號，登入後就能填寫學員資料。","",
    ...
    "## 三分鐘看懂音樂教室",
    "![InRecord 吉祥物](https://inrecordmusic.com/mascot-wave.png|110)","",
