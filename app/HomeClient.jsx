...
const MODULES = [
  { n: 1,  title: "踏上黑白鍵的第一步",             desc: "認識鍵盤與起始音 Do 的位置，建立正確坐姿、手型與手指編號，打好彈琴的第一步基礎。",
    ...
    song: "音階單音練習", game: "音名快閃 — 畫面隨機顯示琴鍵位置，限時點擊正確音名", img: "photo-1520523839897-bd0b52f945a0" },
  { n: 2,  title: "音符的語言—音名與唱名",         desc: "學會音名 C～B 與唱名 Do～Si 的對照，搞懂半音、全音與升降記號，聽懂音樂的共同語言。",
    ...
    song: "唱名歌曲跟彈練習", game: "唱名階梯 — 畫面隨機顯示琴鍵位置，限時點擊正確唱名", img: "photo-1507838153414-b4b713384a76" },
  ...
  { n: 4,  title: "掌握音樂的腳步—節奏與拍子",     desc: "認識拍子、小節與常見音符時值，搭配節拍器練出穩定節奏，讓雙手開始協調合作。",
    ...
    game: "節奏打點師 — 跟隨節拍器，在正確時機點擊螢幕練習穩定性", img: "photo-1514119412350-e174d90d280e" },
  ...
  { n: 6,  title: "和弦的基石—認識大三和弦",       desc: "認識和弦的組成（根音、三音、五音）與大三和弦公式，掌握常用大三和弦，開始用和弦幫歌曲伴奏。",
    ...
    song: "《Happy Birthday to You》（C、F、G 和弦進行）", game: "和弦辨識家 — 辨認大三與小三和弦，辨認和弦的組成音", img: "photo-1520523839897-bd0b52f945a0" },
  { n: 7,  title: "情感的色彩—認識小三和弦",       desc: "聽出大、小三和弦的情緒差異，掌握小三和弦公式與快速辨認，用和弦表現歌曲的情緒。",
    ...
    song: "流行歌曲簡化版和弦進行", game: "情緒調色盤 — 聆聽大、小三和弦，判斷情緒感受（開心／難過）", img: "photo-1514119412350-e174d90d280e" },
  { n: 8,  title: "左手的魔法—基礎伴奏技巧",       desc: "看懂和弦記號，學會根音、柱式與分解和弦三種伴奏法，搭配常見節奏完成左右手合奏。",
    ...
    song: "抒情歌曲右手旋律＋左手分解和弦", game: "分解和弦連連看 — 將和弦組成音按正確分解順序連接", img: "photo-1507838153414-b4b713384a76" },
  { n: 9,  title: "流行音樂的萬用公式",             desc: "認識和弦進行與級數概念，拆解流行歌背後的共同密碼，為旋律配上和弦、完成一首流行歌曲。",
    ...
    song: "卡農和弦進行歌曲片段串燒", game: "和弦神預測 — 聆聽前三個和弦，預測並彈出第四個", img: "photo-1552422535-c45813c61732" },
  { n: 10, title: "你的第一場個人發表會",            desc: "從選曲、拆解段落到安排練習進度，加入力度與情感，完成屬於你的錄音或演出。",
    ...
    song: "流行歌曲完整彈奏（成果發表曲）", game: "自由創作坊 — 自由搭配旋律與伴奏並可錄製分享", img: "photo-1514119412350-e174d90d280e" },
          ...
          <div className={styles.container}>
            ...
            <div className={styles.faq}>
              {[
                ...
                ["什麼時候可以上課？",           <>課程將分批上架，購課學員可依開放進度提前開始上課：<br/>・9/2（20:00 起）— 第一章<br/>・9/9 — 第二章<br/>・9/16 — 第三章<br/>・9/23 — 第四章<br/>・9/30 — 全部章節上架完畢，課程正式上架</>],
