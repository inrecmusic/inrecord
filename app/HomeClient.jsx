...
const MODULES = [
  { n: 1,  title: "踏上黑白鍵的第一步",             desc: "認識鍵盤與起始音 Do 的位置，建立正確坐姿、手型與手指編號，打好彈琴的第一步基礎。",
    ...
    song: "Do 之歌、指法歌", games: ["Do 給你找 — 畫面隨機顯示鍵盤，限時找出並點擊起始音 Do 的位置"], img: "photo-1520523839897-bd0b52f945a0" },
  { n: 2,  title: "音符的語言—音名與唱名",         desc: "學會音名 C～B 與唱名 Do～Si 的對照，搞懂半音、全音與升降記號，聽懂音樂的共同語言。",
    ...
    song: "唱名歌曲跟彈練習", games: ["音名快閃 — 畫面隨機顯示琴鍵位置，限時點擊正確音名", "唱名小達人 — 畫面隨機顯示琴鍵位置，限時點擊正確唱名", "音名唱名連連看 — 將音名與唱名兩兩配對連線，限時完成"], img: "photo-1507838153414-b4b713384a76" },
  { n: 3,  title: "看懂樂譜—五線譜與簡譜",         desc: "從五線譜、高低音譜號到簡譜，一步步對照鍵盤位置，完成基礎視譜練習，樂譜不再是天書。",
    ...
    games: ["五線譜挑戰", "簡譜大師"], img: "photo-1520523839897-bd0b52f945a0" },
          ...
          <div ref={heroContentRef} className={styles.heroGrid}>
            ...
            <motion.div className={styles.heroIntro} variants={stagger} initial="hidden" animate="visible">
              ...
              <motion.div variants={heroRise} className={styles.offerCard}>
                ...
                {showWaveCountdown && (
                  <div className={styles.offerCountdown}>⏳ 限時優惠剩 <strong>{fmtCountdown(waveCountdownMs)}</strong></div>
                )}
