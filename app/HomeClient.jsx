...
const MODULES = [
  ...
  { n: 2,  title: "音符的語言 — 唱名與音階",       desc: "C 大調音階的組成與指法練習，學習 Do Re Mi Fa Sol La Si 唱名系統，搭配音樂跟著彈音階與《小蜜蜂》。",                                    song: "經典唱名歌曲跟彈練習",              game: "唱名階梯 — 畫面隨機顯示琴鍵位置，限時點擊正確唱名",     img: "photo-1507838153414-b4b713384a76" },
  ...
  { n: 4,  title: "情感的色彩 — 小三和弦",         desc: "Am、Em 常用小三和弦的指法與辨識，感受大、小和弦截然不同的情緒色彩，練習土耳其進行曲左手伴奏。",                                          song: "華語流行金曲簡化版和弦進行",                game: "情緒調色盤 — 聆聽大、小三和弦，判斷情緒感受（開心／難過）", img: "photo-1514119412350-e174d90d280e" },
  { n: 5,  title: "12 金鑰 — 認識所有大三和弦",    desc: "升降記號（Sharp #、Flat b）在和弦中的應用，系統性學習全部 12 個大三和弦。",                                                              song: "人氣流行歌和弦進行練習",                          game: "和弦俄羅斯 — 從天而降的和弦方塊，彈出正確和弦消除",      img: "photo-1552422535-c45813c61732" },
  { n: 6,  title: "12 種溫柔 — 認識所有小三和弦",  desc: "大小和弦的快速轉換技巧，系統性學習全部 12 個小三和弦，並與大三和弦對比練習。",                                                            song: "華語抒情金曲副歌和弦進行",              game: "和弦變身術 — 顯示大三和弦，快速彈出對應的小三和弦",      img: "photo-1520523839897-bd0b52f945a0" },
  { n: 7,  title: "左手的魔法 — 基礎伴奏（一）",   desc: "拍子與節奏入門，四四拍全和弦 Block Chord 穩定伴奏法，右手單音旋律搭配左手伴奏。",                                                          song: "浪漫流行金曲右手旋律＋左手全和弦伴奏",  game: "節奏打點師 — 跟隨節拍器，在正確時機點擊螢幕練習穩定性", img: "photo-1514119412350-e174d90d280e" },
  { n: 8,  title: "讓音樂動起來 — 基礎伴奏（二）", desc: "分解和弦（Arpeggio）伴奏法，音型如 1-5-3-5，讓音樂更具流動感與層次。",                                                                  song: "經典抒情金曲右手旋律＋左手分解和弦", game: "分解和弦連連看 — 將和弦組成音按正確分解順序連接",    img: "photo-1507838153414-b4b713384a76" },
  { n: 9,  title: "流行音樂的萬用公式",             desc: "卡農和弦進行（C-G-Am-Em-F-C-F-G），和弦級數概念（I-V-vi-iii-IV-I-IV-V），解鎖流行歌曲背後的共同密碼。",                                   song: "卡農進行經典流行歌曲片段串燒",      game: "和弦神預測 — 聆聽前三個和弦，預測並彈出第四個",          img: "photo-1552422535-c45813c61732" },
  { n: 10, title: "你的第一場個人發表會",            desc: "複習所有三和弦與兩種基本伴奏型態，綜合運用所學，完整彈奏一首流行歌曲，正式展現你的學習成果。",                                              song: "溫暖經典旋律完整彈奏（成果發表曲）",      game: "自由創作坊 — 自由搭配旋律與伴奏並可錄製分享",            img: "photo-1514119412350-e174d90d280e" },
