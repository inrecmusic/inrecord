...
describe("isEarlyBird", () => {
  ...
  it("now == 截止 → false", () => expect(isEarlyBird(base, EB)).toBe(false));
...
describe("currentPrice", () => {
  ...
  it("早鳥價高於原價時取原價（防呆）", () =>
    expect(currentPrice("course", { ...base, plan_pricing: { course: { original: 3800, earlyBird: 4000 } } }, before)).toBe(3800));
});
