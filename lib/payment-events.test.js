...
import { classifyEvent, recordPaymentEvent, extractCardInfo } from "./payment-events";
...
describe("extractCardInfo（信用卡明細：分期／末四碼／授權碼）", () => {
  ...
  it("非物件輸入（null／字串／陣列／undefined）安全回空值，不拋出", () => {
    const blank = { installment: null, installmentState: "missing", installmentRaw: null, last4: null, authCode: null, matchedKeys: { installment: null, last4: null, authCode: null } };
