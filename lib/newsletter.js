...
const S = {
  h1: 'font-size:21px;font-weight:800;color:#0f172a;margin:24px 0 12px;letter-spacing:-.01em;' + CJK,
  h2: 'font-size:17.5px;font-weight:800;color:#2563eb;margin:26px 0 10px;padding-left:11px;border-left:3px solid #2563eb;line-height:1.4;' + CJK,
  h3: 'font-size:16.5px;font-weight:800;color:#1e293b;margin:18px 0 8px;' + CJK,
...
function wrap({ subject, bodyMd, siteUrl, footer }) {
  ...
  const subtitleHtml = subtitle
    ? `<p style="margin:12px 0 0;color:#aab6c8;font-size:15px;line-height:1.7;">${esc(subtitle)}</p>`
    : "";
...
<body style="margin:0;background:#eef2f7;font-family:-apple-system,'Helvetica Neue',Arial,'PingFang TC','Microsoft JhengHei',sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#eef2f7;">
    <tr><td align="center" style="padding:28px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="width:560px;max-width:100%;border-radius:20px;overflow:hidden;box-shadow:0 12px 40px rgba(15,23,42,.10);">
        <!-- 深色頁首 -->
        <tr><td class="ir-head" align="center" bgcolor="#0f172a" style="background-color:#0f172a;padding:38px 40px 34px;">
          ...
          ${badgeHtml}<h1 style="margin:0;color:#ffffff;font-size:24px;line-height:1.45;font-weight:800;letter-spacing:-.01em;">${subj}</h1>
          ${subtitleHtml}
        </td></tr>
        <!-- 白色內文 -->
        <tr><td class="ir-body" bgcolor="#ffffff" style="background-color:#ffffff;padding:34px 32px 38px;color:#3a4657;font-size:16.5px;line-height:1.8;">
          ${body}
          <p style="color:#a6b0bd;font-size:13px;line-height:1.75;margin:32px 0 0;border-top:1px solid #f1f5f9;padding-top:18px;">${footer}</p>
        </td></tr>
      </table>
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:22px auto 0;">
        <tr><td align="center" style="color:#8a94a3;font-size:13.5px;line-height:2.05;font-family:inherit;">
