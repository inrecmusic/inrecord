...
const S = {
  h1: 'font-size:19px;font-weight:800;color:#0f172a;margin:24px 0 12px;letter-spacing:-.01em;' + CJK,
  h2: 'font-size:16px;font-weight:800;color:#2563eb;margin:26px 0 10px;padding-left:11px;border-left:3px solid #2563eb;line-height:1.4;' + CJK,
  h3: 'font-size:15px;font-weight:800;color:#1e293b;margin:18px 0 8px;' + CJK,
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#eef2f7;">
    <tr><td align="center" style="padding:28px 16px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:100%;border-radius:20px;overflow:hidden;box-shadow:0 12px 40px rgba(15,23,42,.10);">
        ...
        <!-- 白色內文 -->
        <tr><td class="ir-body" bgcolor="#ffffff" style="background-color:#ffffff;padding:34px 36px 38px;color:#3a4657;font-size:15px;line-height:1.85;">
          ${body}
