...
<body style="margin:0;background:#eef2f7;font-family:-apple-system,'Helvetica Neue',Arial,'PingFang TC','Microsoft JhengHei',sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#eef2f7;">
    <tr><td align="center" style="padding:28px 16px;">
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" border="0" style="width:520px;max-width:100%;border-radius:20px;overflow:hidden;box-shadow:0 12px 40px rgba(15,23,42,.10);">
        <!-- 深色頁首 -->
        ...
        <!-- 白色內文 -->
        <tr><td class="ir-body" bgcolor="#ffffff" style="background-color:#ffffff;padding:32px 26px 36px;color:#3a4657;font-size:18px;line-height:1.78;">
          ${body}
