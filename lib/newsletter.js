...
// 中文斷句：詞不從中間斷開（keep-all）、行首不出現句讀（strict）、超長英數仍可斷（anywhere 安全網）。
// 沒有這組，《從零開始學鋼琴－了解三和弦與基礎伴奏》這種書名會被攔腰切成兩行。
const CJK = 'word-break:keep-all;line-break:strict;overflow-wrap:anywhere;';
const S = {
  h1: 'font-size:23px;font-weight:800;color:#0f172a;margin:24px 0 12px;letter-spacing:-.01em;' + CJK,
  h2: 'font-size:19px;font-weight:800;color:#2563eb;margin:26px 0 10px;padding-left:11px;border-left:3px solid #2563eb;line-height:1.4;' + CJK,
  h3: 'font-size:18px;font-weight:800;color:#1e293b;margin:18px 0 8px;' + CJK,
