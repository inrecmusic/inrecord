...
function buildHtml({ planLabel, planUnlock, merTradeNo, loginUrl }) {
  return `<!doctype html>
...
<body style="margin:0;background:#f1f5f9;font-family:-apple-system,'Helvetica Neue',Arial,'PingFang TC','Microsoft JhengHei',sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:32px 20px;">
    <div style="background:#fff;border-radius:20px;padding:36px 32px;box-shadow:0 12px 40px rgba(15,23,42,.08);">
      ...
      <h1 style="font-size:24px;color:#0f172a;text-align:center;margin:0 0 6px;letter-spacing:-.02em;">購買成功，課程已開通！</h1>
      <p style="color:#64748b;font-size:15px;text-align:center;margin:0 0 24px;">感謝你加入 InRecord，以下是你的開通資訊。</p>
      <table style="width:100%;border-collapse:collapse;font-size:14px;color:#334155;margin-bottom:24px;">
        <tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;">購買方案</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;text-align:right;font-weight:700;">${planLabel}</td></tr>
        <tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;">開通內容</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;text-align:right;">${planUnlock}</td></tr>
        <tr><td style="padding:10px 0;color:#94a3b8;">訂單編號</td><td style="padding:10px 0;text-align:right;font-family:monospace;">${merTradeNo}</td></tr>
      </table>
      ...
      <p style="color:#64748b;font-size:13px;line-height:1.7;text-align:center;margin:0;">請使用<strong>本次購買的 Email</strong>登入即可看到已開通的內容。<br>如有任何問題，直接回覆此信與我們聯絡。</p>
    </div>
