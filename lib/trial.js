...
export function buildTrialEmail({ email, siteUrl = "https://inrecordmusic.com" }) {
  ...
  const subject = "InRecord｜你的免費試看課來了 🎹";
  const bodyMd = [
    "@badge 免費試看",
    "@subtitle 一堂完整的課程影片，先看再決定。", "",
    `![InRecord 吉祥物](${siteUrl}/mascot-piano-v2.png|110)`, "",
    "你好：", "",
    "謝謝你留下 Email。這是《從零開始學鋼琴－了解三和弦與基礎伴奏》的免費試看課，點下面的按鈕就能看：", "",
    `[觀看免費試看課](${url})`, "",
