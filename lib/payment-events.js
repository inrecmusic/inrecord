...
// 官方 UPP 文件 PaymentType：1 信用卡、2 ATM、3 超商代碼、5 貨到付款、6 icash Pay、7 AFTEE、9 LINE Pay、10 宅配到付、11 街口。
// 7 正式站已實收過；這些「非卡即時付款」沒有卡號／分期資料，明細面板要走自己的版面，不能套信用卡欄位。
const PAY_TYPE_CODE = { 1: "credit", 2: "atm", 3: "cvs", 4: "cvs", 5: "other", 6: "other", 7: "aftee", 9: "other", 10: "other", 11: "other" };
export const PAY_TYPE_LABEL = { credit: "信用卡", atm: "ATM 轉帳", cvs: "超商代碼", aftee: "AFTEE 後支付", other: "電子支付／其他", unknown: "未知" };
