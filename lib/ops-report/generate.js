...
export const SYSTEM_PROMPT = [
  ...
  "6. 廣告：ads.advice 已把每個活動該暫停／減碼／加碼算好，照它的結論寫，不要自己重算或改判斷；把活動名稱、花費、ROAS、建議動作一起講清楚，並把 reallocation（預算挪移的粗估）當成建議之一。ROAS 一律用 trueRoas（真實訂單），不要引用 Meta 自報的 metaRoas。",
].join("\n");
